                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-8 col-lg-9">
                                ...
                                @if($pegawai->file_foto)
                                    <img src="{{ asset('storage/' . $pegawai->file_foto) }}" alt="Profile" class="rounded" style="width: 100px; height: auto;">
                                @else
                                    <img src="{{ asset('image/nophoto.jpg') }}" alt="Profile" class="rounded" style="width: 100px; height: auto;">
                                @endif
                                <div class="pt-2">
                                    <!-- Upload new profile image -->
                                    <label for="file_foto" class="btn btn-primary btn-sm" title="Upload new profile image">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-8 col-lg-9">
                                <input name="no_kartu_keluarga" type="text" class="form-control" id="no_kartu_keluarga"
                                    value="{{ $pegawai->no_kartu_keluarga }}">
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-8 col-lg-9">
                                <textarea name="alamat_lengkap" class="form-control" id="alamat_lengkap"
                                        style="height: 100px">{{ $pegawai->alamat_lengkap }}</textarea>
                            </div>
                        </div>
