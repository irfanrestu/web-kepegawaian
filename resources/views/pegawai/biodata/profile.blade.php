        ...
        <div class="card">
          <div class="card-body pt-3">
            ...
            <ul class="nav nav-tabs nav-tabs-bordered" role="tablist">
              ...
              <li class="nav-item" role="presentation">
                <button class="nav-link" data-bs-toggle="tab" data-bs-target="#profile-dokumen" aria-selected="false"
                  tabindex="-1" role="tab">Dokumen</button>
              </li>
            ...
            <div class="tab-content pt-2">
              ...
              <div class="tab-pane fade pt-3" id="profile-dokumen" role="tabpanel">
                <!-- Change Password Form -->
                @include('dokumen_pendukung.admin')
