                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-8 col-lg-9">
                                    <input name="nama_lengkap" type="text" class="form-control" id="nama_lengkap" value="{{ old('nama_lengkap') }}">
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-8 col-lg-9">
                                    <input name="gelar_belakang" type="text" class="form-control" id="gelar_belakang" value="{{ old('gelar_belakang') }}">
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-8 col-lg-9">
                                    <input name="no_karpeg" type="text" class="form-control" id="no_karpeg" value="{{ old('no_karpeg') }}">
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-8 col-lg-9">
                                    <input name="no_bpjs" type="text" class="form-control" id="no_bpjs" value="{{ old('no_bpjs') }}">
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-8 col-lg-9">
                                    <input name="no_kartu_keluarga" type="text" class="form-control" id="no_kartu_keluarga" value="{{ old('no_kartu_keluarga') }}">
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-8 col-lg-9">
                                    <input name="no_nik" type="text" class="form-control" id="no_nik" value="{{ old('no_nik') }}">
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-8 col-lg-9">
                                    <input name="tempat_lahir" type="text" class="form-control" id="tempat_lahir" value="{{ old('tempat_lahir') }}">
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-8 col-lg-9">
                                    <input name="tanggal_lahir" type="date" class="form-control" id="tanggal_lahir" value="{{ old('tanggal_lahir') }}">
                                </div>
                            </div>
                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            <div class="row mb-3">
                                ...
                                <div class="col-md-8 col-lg-9">
                                    <input name="no_hp" type="text" class="form-control" id="no_hp" value="{{ old('no_hp') }}">
                                </div>
                            </div>
                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            <div class="row mb-3">
                                ...
                                <div class="col-md-8 col-lg-9">
                                    <textarea name="alamat_lengkap" class="form-control" id="alamat_lengkap" style="height: 100px">{{ old('alamat_lengkap') }}</textarea>
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-8 col-lg-9">
                                    <input name="rt" type="text" class="form-control" id="rt" value="{{ old('rt') }}">
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-8 col-lg-9">
                                    <input name="rw" type="text" class="form-control" id="rw" value="{{ old('rw') }}">
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-8 col-lg-9">
                                    <input name="kelurahan" type="text" class="form-control" id="kelurahan" value="{{ old('kelurahan') }}">
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-8 col-lg-9">
                                    <input name="kecamatan" type="text" class="form-control" id="kecamatan" value="{{ old('kecamatan') }}">
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-8 col-lg-9">
                                    <input name="kota_kabupaten" type="text" class="form-control" id="kota_kabupaten" value="{{ old('kota_kabupaten') }}">
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-8 col-lg-9">
                                    <input name="kode_pos" type="text" class="form-control" id="kode_pos" value="{{ old('kode_pos') }}">
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-8 col-lg-9">
                                    <input name="homebase" type="text" class="form-control" id="homebase" value="{{ old('homebase') }}">
                                </div>
                            </div>
                        </div>
                    </div>
