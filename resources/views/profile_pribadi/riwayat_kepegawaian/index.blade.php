<div class="tab-pane fade pt-3" id="riwayar-kepegawaian" role="tabpanel">
            ...
            <div class="card-body m-2">
                <table id="datatablesSimple" class="table table-bordered table-striped p-4 mt-4">
                    ...
                    <tbody>
                        ...
                        @empty
                            <tr>
                                <td colspan="{{ auth()->user()->id_role == 1 ? 6 : 5 }}" class="text-center">Belum ada data
                                    yang tersedia.</td>
                            </tr>
                        @endforelse
                    </tbody>
    ...
    <div class="card mt-4">
        <div class="card-header d-flex justify-content-between align-items-center">
            ...
            <button class="btn btn-sm btn-primary" type="button" data-bs-toggle="collapse" data-bs-target="#formInput"
                aria-expanded="true" aria-controls="formInput">
